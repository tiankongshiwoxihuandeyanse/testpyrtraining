...
class TestAddShop(unittest.TestCase):
    ...
    @parameterized.expand(ReadParameterized("shop","add_shop.json").read_params())
    def test_add_shop(self,case_number):

        param = PostParameter().post_param("shop","add_shop.json",case_number)
